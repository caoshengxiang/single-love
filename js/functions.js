...
$(function () {
  ...
  $('#content').
    css('height', Math.max($loveHeart.height(), $('#code').height()))
  $('#content').
    css('margin-top',
...
function getHeartPoint (c) {
  ...
  var d = -20 * (13 * Math.cos(b) - 5 * Math.cos(2 * b) - 2 * Math.cos(3 * b) -
    Math.cos(4 * b))
...
function adjustCodePosition () {
  $('#code').
    css('margin-top', ($('#garden').height() - $('#code').height()) / 2)
}
